    ...
    for epoch in range(epochs):
        ...
        for inputs, labels in train_loader:
            ...
            if isinstance(outputs, dict):
                # Para modelos de segmentação que retornam dicionário
                outputs = outputs['out']
...
def compute_metrics(model, dataloader, classes):
    ...
    if len(classes) == 2:
        ...
        try:
            ...
            st.write(f"Erro ao calcular AUC-ROC para multiclasse: {e}")
...
def visualize_activations(model, image, class_names, model_name, run_id, segmentation_model=None, segmentation=False):
    ...
    # Função auxiliar para obter a camada de destino
    ...
    # Determinar a camada de destino
